const educationData = [
    ...
    },
    {
        ...
        type: 'Fulltime',
        date: '2016 ~ 2017',
        description: "In my second year at BFEI, I transitioned into Creative Multimedia, which became a key foundation for many of the skills I use today. The course focused heavily on visual design, with in-depth training in Photoshop and Illustrator, alongside core web technologies like JavaScript, jQuery, and database management. Toward the end, I completed a Java crash course that sparked a deeper interest in programming and ultimately led to my admission to IADT.",
    ...
    },
    {
        ...
        type: 'Fulltime',
        date: '2015 ~ 2016',
        description: "After finishing at Newpark, I went on to study Game Design at BFEI. There, I explored tools like the Unity Game Engine, picked up the basics of Photoshop, and got a taste of real-world experience while shadowing a freelance animator. It was also my first exposure to coding, learning C# to build game mechanics within Unity, which opened the door to a whole new way of thinking creatively.",
        location: 'Blackrock, Ireland',
    },
    {
        side: 'left',
